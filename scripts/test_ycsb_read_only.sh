...
echo "This test sends both read and write requests to both vssd 1 and vssd 2 using a subset of the YCSBC trace"
...
ssh -t $CLIENT "cd ~/client_code; ./run.sh YCSBC_small.trace 10000 9500 1> ${CLIENT_LOG} 2> ${CLIENT_ERROR}" 
echo "Done.."
